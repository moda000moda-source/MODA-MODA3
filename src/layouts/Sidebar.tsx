      ...
      <nav className="flex-1 overflow-y-auto px-2 py-3 space-y-1 scrollbar-thin scrollbar-thumb-neutral-800">
        ...
        >
          <div className="flex items-center space-x-3">
            ...
            {!isCollapsed && (
              <span className="flex items-center font-semibold text-xs text-white">
                应用生态
                <span className="ml-1.5 px-1 py-0.2 bg-blue-650 text-white text-[8px] rounded font-mono font-normal uppercase">插件</span>
              </span>
            )}
          </div>
          {isCollapsed && (
          ...
          return (
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                {!isCollapsed && (
                  <span className="font-medium text-xs text-neutral-200 truncate max-w-[130px]" title={app.name}>
                    {app.name}
                  </span>
                )}
              </div>
