  ...
  return (
    <div className="space-y-4 max-w-7xl mx-auto px-4 py-4 text-neutral-900 select-none animate-fadeIn font-sans">
      ...
      {currentTab === 'appstero' ? (
        <>
          {/* 生态大盘页头部：极致黑白，极简无噪 */}
          <div className="flex flex-col md:flex-row md:items-center justify-between border-b border-neutral-200 pb-4 gap-3 bg-white p-5 rounded-lg shadow-2xs">
            <div>
              <div className="flex items-center space-x-2">
                <span className="px-1.5 py-0.5 bg-blue-50 text-blue-600 text-[10px] font-bold rounded">开放生态</span>
                <span className="text-neutral-300">/</span>
                <span className="text-[10px] text-neutral-500 font-mono tracking-widest uppercase">系统应用中心</span>
              </div>
            ...
            <div className="flex items-center space-x-4 bg-neutral-50 p-3 rounded-lg border border-neutral-200 shrink-0">
              <div className="text-center px-1">
                <span className="block text-[9px] text-neutral-400 font-bold">运行状态</span>
                <span className="text-xs font-bold text-neutral-800 flex items-center justify-center space-x-1.5 mt-0.5">
              ...
              <div className="text-center px-1">
                <span className="block text-[9px] text-neutral-400 font-bold">已启用插件</span>
          ...
          {/* 搜索与分类导航栏 */}
          <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-2.5 bg-white p-3 rounded-lg border border-neutral-200 shadow-2xs">
            ...
            <div className="relative w-full md:w-64">
              ...
              <input
                ...
                className="w-full bg-neutral-50 border border-neutral-200 rounded px-2.5 py-1 pl-8 text-xs focus:ring-1 focus:ring-blue-600 focus:outline-none focus:bg-white"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {filteredApps.map((app) => {
              ...
              return (
                <div 
                  key={app.id}
                  className="bg-white rounded-lg border border-neutral-200 p-4 flex flex-col justify-between hover:border-blue-600/50 hover:shadow-2xs transition-all duration-150"
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-2.5">
                        <div className="w-9 h-9 rounded bg-neutral-900 flex items-center justify-center text-white shrink-0">
                      ...
                      <div className="flex items-center space-x-1 text-[10px] font-bold text-blue-600 bg-blue-50/50 px-1.5 py-0.5 rounded border border-blue-100 font-mono">
                    ...
                    <div className="space-y-1">
                      <span className="text-[9px] font-bold text-blue-600 bg-blue-50 px-1 py-0.2 rounded inline-block font-mono">
                  ...
                  <div className="pt-3 mt-3 border-t border-neutral-100 flex items-center justify-between">
                    {app.isInstalled ? (
                      <>
                        <span className="text-[10px] text-blue-600 font-bold bg-blue-50 px-1.5 py-0.5 rounded border border-blue-100">已部署</span>
                        <div className="flex items-center space-x-1.5">
                          <button
                            ...
                            className="px-2 py-1 border border-neutral-200 hover:bg-red-50 hover:text-red-650 text-neutral-500 text-[10px] rounded cursor-pointer transition-colors"
                          >
                            卸载
                          </button>
                          <button
                            onClick={() => setCurrentTab(`app-${app.id}`)}
                            className="px-3 py-1 bg-neutral-900 hover:bg-neutral-800 text-white font-bold text-[10px] rounded cursor-pointer transition-colors flex items-center space-x-1 shadow-2xs"
                          >
                      ...
                      <>
                        ...
                        <button
                          ...
                          className="px-3.5 py-1 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[10px] rounded cursor-pointer transition-all shadow-2xs flex items-center space-x-1"
                        >
        ...
        /* 独立精修插件设置工作台：深度对齐黑白+品牌蓝，去掉废话，操作无死角 */
        <div className="space-y-4">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-neutral-200 pb-3 gap-3 bg-white p-4 rounded-lg shadow-2xs">
            <div className="flex items-center space-x-3">
              <button 
                onClick={() => setCurrentTab('appstero')}
                className="p-1 px-2.5 bg-white hover:bg-neutral-50 border border-neutral-200 text-neutral-700 rounded text-xs transition-all cursor-pointer flex items-center justify-center space-x-1 shadow-2xs"
              >
                <ArrowLeft className="w-3 h-3 text-neutral-500" />
                <span className="font-medium text-[10px]">返回生态大盘</span>
              </button>
              
              <div className="flex items-center space-x-2 bg-neutral-50 pr-3.5 rounded-lg border border-neutral-100">
                <div className="w-8 h-8 bg-neutral-900 text-white flex items-center justify-center rounded-l shadow-xs">
                  {React.createElement(appIcons[activeApp?.iconName || 'MessageSquare'] || MessageSquare, { className: 'w-4 h-4 text-blue-500' })}
                </div>
                <div>
                  <div className="flex items-center space-x-1.5 pl-2">
                    <h1 className="text-xs font-bold text-neutral-900">{activeApp?.name}</h1>
                    <span className="px-1 py-0.1 bg-blue-50 text-blue-600 text-[8px] rounded font-mono font-bold">运行中</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="px-2.5 py-1 border border-neutral-200 text-neutral-500 hover:text-red-650 hover:bg-red-50 text-[10px] rounded cursor-pointer transition-colors"
            >
              一键物理注销
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              {activeAppId === 'fx-converter' && (
                <div className="space-y-4 bg-white p-4 rounded-lg border border-neutral-200 shadow-2xs">
                  <div className="border-b border-neutral-150 pb-2.5">
                    ...
                    <p className="text-[10px] text-neutral-400 mt-0.5">以欧元 (EUR) 为基准本币，自动化对齐和测试结算。如果调整后需要更新网店，请点击保存汇率。</p>
                  </div>

                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-neutral-400 font-mono uppercase">1 EUR 兑 人民币 (CNY)</label>
                      <input 
                        type="number" 
                        step="0.01"
                        value={activeApp?.config?.eurToCny || 7.82}
                        onChange={(e) => updateAppConfig('fx-converter', { eurToCny: parseFloat(e.target.value) || 0 })}
                        className="w-full bg-neutral-50 border border-neutral-200 rounded px-2 py-1 text-xs text-neutral-900 font-mono font-bold focus:ring-1 focus:ring-blue-600 focus:outline-none"
                      />
                    </div>
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-neutral-400 font-mono uppercase">1 EUR 兑 美元 (USD)</label>
                      <input 
                        type="number" 
                        step="0.01"
                    ...
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-neutral-400 font-mono uppercase">1 EUR 兑 英镑 (GBP)</label>
                      <input 
                        type="number" 
                        step="0.01"
                  ...
                  {/* 汇率沙盒 */}
                  <div className="bg-neutral-50 p-3 rounded border border-neutral-200 font-mono">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[9px] font-black text-neutral-500">汇率结算计算器 (模拟环境)</span>
                      <span className="text-[8px] bg-blue-100 text-blue-600 font-bold px-1 rounded uppercase">自动连通</span>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="relative w-1/3">
                        ...
                        <input 
                          ...
                          className="w-full bg-white border border-neutral-200 rounded py-1 pl-6 pr-2 text-xs focus:ring-1 focus:ring-blue-600 focus:outline-none font-bold"
                        />
                      </div>
                      <ArrowRight className="w-3.5 h-3.5 text-neutral-400" />
                      <div className="flex-1 grid grid-cols-3 gap-2">
                        <div className="bg-white p-1 rounded border border-neutral-150 text-center">
                  ...
                  <div className="flex justify-end pt-1">
                    <button 
                      ...
                      className="px-3.5 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded shadow-2xs transition-colors cursor-pointer"
                    >
                      保存汇率设定
                    </button>
                  </div>
              ...
              {activeAppId === 'live-bubble' && (
                <div className="space-y-4 bg-white p-4 rounded-lg border border-neutral-200 shadow-2xs">
                  <div className="border-b border-neutral-150 pb-2.5">
                    ...
                    <p className="text-[10px] text-neutral-400 mt-0.5">控制放置于前台展示网店右下角的智能微聊天框，随时在线为尊贵顾客保驾护航。</p>
                  </div>

                  <div className="space-y-3">
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold text-neutral-400">气泡问候寄语</label>
                      <input
                        type="text"
                        value={activeApp?.config?.greetingMsg || ''}
                        onChange={(e) => updateAppConfig('live-bubble', { greetingMsg: e.target.value })}
                        className="w-full bg-neutral-50 border border-neutral-200 rounded px-2.5 py-1.5 text-xs text-neutral-900 focus:outline-none focus:ring-1 focus:ring-blue-600"
                      />
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1.5">
                        <label className="text-[10px] font-bold text-neutral-400 block">调配品牌色系</label>
                        <div className="flex items-center space-x-2">
                          {['#2563eb', '#1e293b', '#111111', '#2563eb'].map((col, idx) => {
                            if (idx > 2) return null; // Remove extra variations
                            const labels = ['品牌精质蓝', '典雅矿物灰', '无极深邃黑'];
                            return (
                              <button
                                key={col}
                                onClick={() => {
                                ...
                                className="px-2 py-1 border border-neutral-200 hover:border-blue-600 rounded bg-white text-[10px] font-medium flex items-center space-x-1.5 cursor-pointer"
                              >
                  ...
                  {/* 聊天沙盒模拟 */}
                  <div className="border border-neutral-200 rounded overflow-hidden mt-3 shadow-2xs">
                    <div className="bg-neutral-900 p-2 text-white flex items-center justify-between">
                      <div className="flex items-center space-x-1.5">
                        <span className="w-2 h-2 rounded-full bg-blue-500"></span>
                        <span className="text-[10px] font-mono font-bold">气泡会话实体预览</span>
                      </div>
                      <span className="text-[9px] text-neutral-400">已载入星火智能对答</span>
                    </div>

                    <div className="p-3 bg-neutral-50 h-40 overflow-y-auto space-y-2 flex flex-col text-xs">
                      {chatMessages.map((m, idx) => (
                        <div 
                          key={idx} 
                          className={`max-w-[80%] rounded p-2 text-[11px] leading-relaxed ${
                            m.sender === 'agent' 
                    ...
                    <div className="border-t border-neutral-155 bg-white p-2.5 flex items-center space-x-1.5">
                      <input 
                        type="text" 
                        value={chatInput}
                        ...
                        className="flex-1 bg-neutral-50 border border-neutral-200 rounded px-2.5 py-1 text-xs focus:outline-none"
                      />
                      <button 
                        onClick={handleSendChat}
                        className="p-1 px-2 text-xs bg-blue-600 hover:bg-blue-500 text-white font-bold rounded cursor-pointer transition-transform active:scale-95 flex items-center space-x-1"
                      >
                  ...
                  <div className="space-y-3">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          className="w-full bg-neutral-50 border border-neutral-200 rounded px-2 py-1.5 text-xs text-neutral-900 font-bold focus:ring-1 focus:ring-blue-600 focus:outline-none"
                        />
                      </div>
                      <div className="space-y-1">
                        ...
                        <input 
                          ...
                          className="w-full bg-neutral-50 border border-neutral-200 rounded px-2 py-1.5 text-xs text-neutral-900 font-mono focus:ring-1 focus:ring-blue-600 focus:outline-none"
                        />
                      </div>
                    </div>
                    ...
                    <div className="bg-neutral-50 rounded p-3 border border-neutral-200 flex items-center justify-between">
                      ...
                      <button
                        ...
                        className="px-3 py-1 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[10px] rounded cursor-pointer transition-all flex items-center space-x-1"
                      >
              ...
              {activeAppId === 'smart-courier' && (
                <div className="space-y-4 bg-white p-4 rounded-lg border border-neutral-200 shadow-2xs">
                  <div className="border-b border-neutral-150 pb-2.5">
                    ...
                    <p className="text-[10px] text-neutral-400 mt-0.5">直接打通大盘已授权订单流水。可自定义选择订单，生成出境保价托托运面单。</p>
                  </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <select 
                        ...
                        className="w-full bg-neutral-50 border border-neutral-200 rounded px-2.5 py-1.5 text-xs text-neutral-900 font-medium focus:outline-none focus:ring-1 focus:ring-blue-600"
                      >
                  ...
                  <div className="space-y-2 mt-2">
                          ...
                          {orders.filter(o => o.fulfillmentStatus === 'unfulfilled').length > 0 ? (
                            orders.filter(o => o.fulfillmentStatus === 'unfulfilled').map(o => (
                              <tr key={o.id} className="border-b border-neutral-150 hover:bg-neutral-100/50">
                                ...
                                <td className="p-2 font-mono">€ {o.total}</td>
                              </tr>
                            ))
                          ) : (
                            <tr>
                    ...
                    <div className="flex justify-between items-center pt-2">
                      <span className="text-[10px] text-neutral-400 font-bold">已勾选 {selectedOrderIds.length} 笔未履订单</span>
                      <button
                        onClick={handleFulfillOrders}
                        className="px-3.5 py-1 bg-blue-600 hover:bg-blue-500 text-white font-bold text-[11px] rounded transition-transform active:scale-97 cursor-pointer shadow-2xs"
                      >
                        一键批量承运打单
                      </button>
                    </div>
                  ...
                  {/* 面单输出打印机 */}
                  {printLabel && (
                    <div className="bg-white rounded border-2 border-neutral-900 p-4 font-mono text-[10px] leading-relaxed max-w-md mx-auto space-y-2 mt-4 relative shadow-md">
                      <div className="absolute right-3 top-3 text-[18px] font-black text-neutral-900 border-2 border-neutral-900 p-1 rounded-sm rotate-12 select-none uppercase tracking-widest text-[9px]">已保价</div>
              ...
              {activeAppId === 'ai-writer' && (
                <div className="space-y-4 bg-white p-4 rounded-lg border border-neutral-200 shadow-2xs">
                  <div className="border-b border-neutral-150 pb-2.5">
                    ...
                    <p className="text-[10px] text-neutral-400 mt-0.5">选取您的货源商品，并即时一键生成极具品格深度的极简中文流丽商详描述。</p>
                  </div>

                  <div className="space-y-3.5">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-neutral-400 block">选取商品原型</label>
                        <select 
                          value={aiSelectedProductId}
                          onChange={(e) => setAiSelectedProductId(e.target.value)}
                          className="w-full bg-neutral-50 border border-neutral-200 rounded px-2.5 py-1.5 text-xs focus:ring-1 focus:ring-blue-600 focus:outline-none text-neutral-900"
                        >
                      ...
                      <div className="space-y-1">
                        <label className="text-[10px] font-bold text-neutral-400 block">拟定文本调性风格</label>
                        <select 
                          value={aiStyle}
                    ...
                    <div className="flex justify-end pt-1">
                      <button
                        ...
                        className="px-4 py-2 bg-neutral-910 hover:bg-neutral-850 text-white font-bold text-xs rounded transition-all active:scale-97 shrink-0 cursor-pointer flex items-center space-x-1 shadow-2xs"
                      >
                        {aiGenerating ? (
                          <>
                    ...
                    {/* 文案展示框 */}
                    {aiGeneratedCopy && (
                      <div className="bg-neutral-50 rounded border border-neutral-200 p-3.5 text-xs whitespace-pre-wrap leading-relaxed">
                        <div className="flex items-center justify-between border-b border-neutral-200 pb-1.5 mb-2">
                          <span className="text-[9px] font-bold text-blue-600 font-mono uppercase">星火专属生成段</span>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-neutral-900 text-white p-4 rounded-lg shadow-2xs space-y-2.5">
                <span className="text-[9px] font-bold text-blue-500 font-mono tracking-widest uppercase block">高精生态赋能</span>
      ...
      {showExitIntentSim && (
        <div className="fixed inset-0 bg-[#111]/80 backdrop-blur-xs flex items-center justify-center z-55 p-4 animate-fadeIn">
          <div className="bg-white rounded-lg border-2 border-neutral-900 p-6 max-w-md w-full relative shadow-2xl space-y-4 text-center">
            <button 
            ...
            <div className="bg-neutral-50 p-4 rounded-md border border-neutral-180 border-dashed space-y-1 font-mono">
              <span className="block text-[8px] text-neutral-400 font-bold uppercase">立减核销密匙</span>
              <span className="block text-lg font-black text-blue-600 tracking-wider font-mono">{activeApp?.config?.discountCode || 'STAY15'}</span>
            ...
            <button 
              ...
              className="w-full py-2 bg-neutral-900 hover:bg-neutral-800 text-white font-bold text-xs rounded transition-transform active:scale-97 cursor-pointer shadow-sm flex items-center justify-center space-x-1"
            >
