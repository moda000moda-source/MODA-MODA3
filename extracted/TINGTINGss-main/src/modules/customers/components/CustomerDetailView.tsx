      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white border border-neutral-200 rounded-xl p-5 shadow-xs space-y-4">
            ...
            <div className="bg-[#fbfcff] border border-blue-100 rounded-lg p-3 text-xs font-mono">
              <div className="flex items-center space-x-1.5 text-indigo-850 font-bold mb-1">
                <Sparkles className="w-4 h-4" />
                <span>客群价值预测 (CLV)</span>
              </div>
              <p className="text-neutral-550 leading-relaxed text-[11px]">
