          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white border border-neutral-200 rounded-xl p-5 shadow-xs space-y-4">
                ...
                <div className="bg-[#fcfeff] border border-blue-150 p-4 rounded-xl font-mono text-xs space-y-3">
                  <span className="text-[9px] uppercase text-indigo-750 font-extrabold tracking-wider block">批发专属折扣商品价格表(Catalogs Mappings)</span>
                  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-2 bg-white border border-blue-100 p-3 rounded-lg">
                    <div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-neutral-200 rounded-xl p-5 shadow-xs space-y-4">
                ...
                <div className="bg-indigo-25/50 border border-blue-150 p-3 rounded-lg text-xs font-mono space-y-1.5 text-indigo-900">
                  <div className="flex items-center space-x-1 font-bold">
                    <Scroll className="w-4 h-4 text-indigo-750" />
                    <span>欠款挂账及支用预警</span>
                  </div>
